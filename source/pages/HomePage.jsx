...
// --- HÀM HỖ TRỢ LẤY LINK ẢNH (QUAN TRỌNG) ---
  ...
  // --- 1. LOAD HERO MOVIES (THAY THẾ HARDCODE CŨ) ---
  useEffect(() => {
    const loadHero = async () => {
      try {
        // Gọi API lấy danh sách phim thường (trang 1, 5 phim)
        const response = await movieService.getMovies(1, 5);
        const movies = response.data || [];
        setHeroMovies(movies);
      } catch (error) {
        console.error('Lỗi tải phim Hero:', error);
        // Nếu lỗi thì dùng tạm danh sách rỗng (sẽ hiện placeholder)
        setHeroMovies([]); 
      }
    };
    loadHero();
  ...
  // 5 phim doanh thu cao nhất (Hero) - Hardcode
  const topMovies = [
    {
      id: 1,
      title: 'Sherlock Jr.',
    ...
    },
    {
      ...
      title: 'The General',
      year: '1926',
      poster: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/The_General_1927_Poster.jpg/440px-The_General_1927_Poster.jpg',
    },
    {
      id: 3,
      title: 'City Lights',
      year: '1931',
      poster: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/City_Lights_%281931_theatrical_poster%29.jpg/440px-City_Lights_%281931_theatrical_poster%29.jpg',
    },
    {
      id: 4,
      title: 'Nosferatu',
  ...
  const defaultPopularMovies = [
    ...
    { id: 7, title: 'Avatar', year: '2009', poster: 'https://upload.wikimedia.org/wikipedia/en/b/b0/Avatar_%282009_film%29.jpg' },
    { id: 8, title: 'Inception', year: '2010', poster: 'https://upload.wikimedia.org/wikipedia/en/2/2e/Inception_%282010%29_theatrical_poster.jpg' },
    { id: 9, title: 'Titanic', year: '1997', poster: 'https://upload.wikimedia.org/wikipedia/en/2/2e/Titanic_%281997_film%29_poster.jpg' },
    { id: 10, title: 'Avengers Endgame', year: '2019', poster: 'https://upload.wikimedia.org/wikipedia/en/0/0d/Avengers_Endgame_poster.jpg' },
    { id: 11, title: 'Black Panther', year: '2018', poster: 'https://upload.wikimedia.org/wikipedia/en/0/06/Black_Panther_%28film%29_poster.jpg' },
    { id: 12, title: 'Doctor Strange', year: '2016', poster: 'https://upload.wikimedia.org/wikipedia/en/d/d7/Doctor_Strange_poster.jpg' },
    { id: 13, title: 'Guardians of the Galaxy', year: '2014', poster: 'https://upload.wikimedia.org/wikipedia/en/d/d5/Guardians_of_the_Galaxy_Vol_2_poster.jpg' },
    { id: 14, title: 'Thor Ragnarok', year: '2017', poster: 'https://upload.wikimedia.org/wikipedia/en/0/0b/Thor_Ragnarok_poster.jpg' },
    { id: 15, title: 'Captain America Civil War', year: '2016', poster: 'https://upload.wikimedia.org/wikipedia/en/5/53/Captain_America_Civil_War_poster.jpg' },
    { id: 16, title: 'Iron Man', year: '2008', poster: 'https://upload.wikimedia.org/wikipedia/en/e/e6/Iron_Man_%282008_film%29_poster.jpg' },
    { id: 17, title: 'The Avengers', year: '2012', poster: 'https://upload.wikimedia.org/wikipedia/en/f/f9/The_Avengers_%282012%29_poster.jpg' },
    { id: 18, title: 'Age of Ultron', year: '2015', poster: 'https://upload.wikimedia.org/wikipedia/en/1/1b/Avengers_Age_of_Ultron_poster.jpg' },
    { id: 19, title: 'Black Widow', year: '2021', poster: 'https://upload.wikimedia.org/wikipedia/en/0/05/Black_Widow_%282021_film%29_poster.jpg' },
    { id: 20, title: 'Shang-Chi', year: '2021', poster: 'https://upload.wikimedia.org/wikipedia/en/c/c2/Shang-Chi_and_the_Legend_of_the_Ten_Rings.jpg' },
    { id: 21, title: 'Eternals', year: '2021', poster: 'https://upload.wikimedia.org/wikipedia/en/a/an/Eternals_poster.jpg' },
    { id: 22, title: 'Spider-Man No Way Home', year: '2021', poster: 'https://upload.wikimedia.org/wikipedia/en/0/06/Spider-Man_No_Way_Home_poster.jpg' },
    { id: 23, title: 'Doctor Strange Multiverse', year: '2022', poster: 'https://upload.wikimedia.org/wikipedia/en/9/95/Doctor_Strange_in_the_Multiverse_of_Madness.jpg' },
  ];
  ...
  const defaultTopRated = [
    ...
    { id: 24, title: 'Pulp Fiction', year: '1994', rating: '8.9', poster: 'https://upload.wikimedia.org/wikipedia/en/8/8b/Pulp_Fiction_poster.jpg' },
    { id: 25, title: 'Forrest Gump', year: '1994', rating: '8.8', poster: 'https://upload.wikimedia.org/wikipedia/en/6/67/Forrest_Gump_poster.jpg' },
    { id: 26, title: 'Inception', year: '2010', rating: '8.8', poster: 'https://upload.wikimedia.org/wikipedia/en/2/2e/Inception_%282010%29_theatrical_poster.jpg' },
    { id: 27, title: 'Fight Club', year: '1999', rating: '8.8', poster: 'https://upload.wikimedia.org/wikipedia/en/f/fc/Fight_Club_poster.jpg' },
    { id: 28, title: 'The Matrix', year: '1999', rating: '8.7', poster: 'https://upload.wikimedia.org/wikipedia/en/c/c1/The_Matrix_Poster.jpg' },
    { id: 29, title: 'Goodfellas', year: '1990', rating: '8.7', poster: 'https://upload.wikimedia.org/wikipedia/en/8/83/Goodfellas.jpg' },
    { id: 30, title: 'The Silence of the Lambs', year: '1991', rating: '8.6', poster: 'https://upload.wikimedia.org/wikipedia/en/8/86/The_Silence_of_the_Lambs_poster.jpg' },
    { id: 31, title: 'Se7en', year: '1995', rating: '8.6', poster: 'https://upload.wikimedia.org/wikipedia/en/a/a5/Se7en.jpg' },
    { id: 32, title: 'Parasite', year: '2019', rating: '8.6', poster: 'https://upload.wikimedia.org/wikipedia/en/5/53/Parasite_%282019_film%29.png' },
    { id: 33, title: 'Saving Private Ryan', year: '1998', rating: '8.6', poster: 'https://upload.wikimedia.org/wikipedia/en/a/ac/Saving_private_ryan_ver2.jpg' },
    { id: 34, title: 'The Green Mile', year: '1999', rating: '8.6', poster: 'https://upload.wikimedia.org/wikipedia/en/5/51/The_Green_Mile_poster.jpg' },
    { id: 35, title: 'Interstellar', year: '2014', rating: '8.6', poster: 'https://upload.wikimedia.org/wikipedia/en/0/0b/Interstellar_film_poster.jpg' },
    { id: 36, title: 'The Usual Suspects', year: '1995', rating: '8.5', poster: 'https://upload.wikimedia.org/wikipedia/en/2/2e/The_Usual_Suspects_poster.jpg' },
    { id: 37, title: 'Gladiator', year: '2000', rating: '8.5', poster: 'https://upload.wikimedia.org/wikipedia/en/6/6f/Gladiator_%282000%29_poster.jpg' },
    { id: 38, title: 'The Prestige', year: '2006', rating: '8.5', poster: 'https://upload.wikimedia.org/wikipedia/en/b/b8/The_Prestige_poster.jpg' },
    { id: 39, title: 'The Departed', year: '2006', rating: '8.5', poster: 'https://upload.wikimedia.org/wikipedia/en/3/3a/The_Departed_poster.jpg' },
    { id: 40, title: 'Whiplash', year: '2014', rating: '8.5', poster: 'https://upload.wikimedia.org/wikipedia/en/3/33/Whiplash_%282014%29_poster.jpg' },
  ];

  const currentMovie = topMovies[heroIndex];
  const currentHeroMovie = heroMovies.length > 0 ? heroMovies[heroIndex] : null;
...
return (
    <div className="space-y-14 bg-white text-gray-900 pb-10">
      ...
      <section className="relative bg-white min-h-[500px]">
        {currentHeroMovie ? (
          <div className="flex justify-center items-center relative py-8 bg-pink-50/50">
            <button
              onClick={() => setHeroIndex((heroIndex - 1 + heroMovies.length) % heroMovies.length)}
            ...
            <div className="w-full max-w-sm transform hover:scale-105 transition-transform duration-300">
              <Link to={`/movie/${currentHeroMovie.id || currentHeroMovie._id}`}>
                  <img
                  src={getPosterUrl(currentHeroMovie)} // Sử dụng hàm chuẩn
                  alt={currentHeroMovie.title}
                  className="w-full rounded-lg shadow-2xl border-4 border-white cursor-pointer"
                  onError={(e) => {e.target.src = 'https://via.placeholder.com/500x750?text=Error'}}
                  />
              </Link>
              <div className="mt-6 text-center">
                <h3 className="text-3xl font-bold text-gray-900 font-serif">{currentHeroMovie.title}</h3>
          ...
          // Hiệu ứng Loading khi chưa có dữ liệu Hero
        ...
        <div className="relative group">
          ...
          <div className="grid grid-cols-3 gap-6">
            {currentPopularMovies.map((movie) => (
              <Link to={`/movie/${movie.id || movie._id}`} key={movie.id || movie._id} className="block group/card">
